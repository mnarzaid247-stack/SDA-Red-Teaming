...
const ResilienceTrend = () => {
  ...
  return (
    <section
      ...
      {/* Header and Legend: Explains the metrics being tracked */}
      ...
      {/* Chart Visualization: SVG-based rendering for optimal performance */}
      <div className="relative h-[450px] w-full mt-8 flex">
        ...
        <div
          ...
          {/* SVG Gradient definitions for aesthetic UI flow */}
          <svg
